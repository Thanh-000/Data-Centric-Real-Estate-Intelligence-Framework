...
The model comparison shows that XGBoost produces the best overall predictive performance. It reduces test RMSE by approximately 10.7\% relative to random forest and by approximately 69.6\% relative to the median baseline. This justifies the use of a non-linear supervised model for the valuation core.
